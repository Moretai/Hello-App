...
export const loadMoreOrderListRequested = createAction('order/LOAD_MORE_ORDER_LIST_REQUESTED')
export const loadMorOrderListSucceed = createAction('order/LOAD_MORE_ORDER_LIST_SUCCEED')
export const loadMoreOrderListFailed = createAction('order/LOAD_MORE_ORDER_LIST_FAILED')
